...
<section>
    <div class="px-[100px] py-6">
        ...
        <div class="flex items-center justify-center gap-2 mb-6">
            ...
            <h2 class="font-bold text-[36px] text-[#041D4D]">Staf Pengajar</h2>
        </div>
                ...
                <div class="w-full sm:w-1/3 md:w-1/4">
                    <div class="flex flex-col items-center gap-3 bg-white shadow-md h-[300px] rounded-[8px] overflow-hidden">
                        ...
                        <div class="flex flex-col gap-1">
                            <h6 class="font-bold text-2xl text-[#041D4D]">Nabil</h6>
                        </div>
                    </div>
                </div>
                <div class="w-full sm:w-1/3 md:w-1/4">
                    <div class="flex flex-col items-center gap-3 bg-white shadow-md h-[300px] rounded-[8px] overflow-hidden">
                        <img src="{{ asset('/assets/profile.jpg') }}" alt=""
                            class="w-full h-[250px] object-cover object-center">
                        <div class="flex flex-col gap-1">
                            <h6 class="font-bold text-2xl text-[#041D4D]">Pika</h6>
                        </div>
                    </div>
                </div>
                <div class="w-full sm:w-1/3 md:w-1/4">
                    <div class="flex flex-col items-center gap-3 bg-white shadow-md h-[300px] rounded-[8px] overflow-hidden">
                        <img src="{{ asset('/assets/profile.jpg') }}" alt=""
                            class="w-full h-[250px] object-cover object-center">
                        <div class="flex flex-col gap-1">
                            <h6 class="font-bold text-2xl text-[#041D4D]">ZAki</h6>
                        </div>
                    </div>
                </div>
        </div>
